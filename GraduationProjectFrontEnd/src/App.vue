        ...
        <!-- Menu -->
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><RouterLink class="nav-link" to="/signin"><img src="../public/asset/images/user.svg"></RouterLink></li>
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="border-top copyright">
					<div class="row pt-4">
						<div class="col-lg-6">
							<p class="mb-2 text-center text-lg-start">Copyright &copy;{{ new Date().getFullYear() }}. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Untree.co</a> Distributed By <a hreff="https://themewagon.com">ThemeWagon</a>  <!-- License information: https://untree.co/license/ -->
            </p>
						</div>
